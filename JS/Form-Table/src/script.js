...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        valid = validateText(form.elements.address, 1, 100, /^[a-zA-Z0-9]+(?:[ ,-][a-zA-Z0-9]+)*$/, 'addressError', 'Alphanumeric, spaces, commas and hyphens are only allowed') && valid;
        ...
        valid = validateCheckbox('communication', 'communicationError', 'Select at least one communication method', form) && valid;
        ...
        valid = validateText(form.elements.hobbies, 3, 25, /^[a-zA-Z]+(?:,[a-zA-Z]+|-?[a-zA-Z]+)*$/, 'hobbiesError', ' Max.Length-25, Min.Length-3 , Alphabets , commas and hyphens are only allowed') && valid;
        valid = validateAdditionalNotes(form.elements.notes, /^[a-zA-Z0-9]+(?:[,.][a-zA-Z0-9]+)*$/, 'notesError', 'Alphanumeric characters with spaces, commas and dots are only allowed') && valid;
        ...
        if (valid) {
            ...
            const successMessageElement = document.querySelector('#successMessage');
            successMessageElement.textContent = 'All information is entered successfully!';
            employeeIdInput.value = generateRandomEmployeeId();
        }
